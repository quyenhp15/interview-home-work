    ...
    getMessage() {
        ...
        comment.addEventListener('submit', (e) => {
            ...
            if (commentInput.value)  {
                this.socket.emit('chat message', commentInput.value);
                commentInput.value = '';
            }
        });
                  ...
                  <div style = {{width: '100%'}}>
                    ...
                    <Collapse onChange={callback} style = {{margin: '5px'}}>
                        ...
                        {/* <div className = 'comment'>
                          <TextArea className = 'commentInput' placeholder="Write comments...." autoSize style = {{width: '96%', backgroundColor: 'white'}}/>
                          <button type="submit">Send</button>
                        </div> */}

                        <Form name = "form">
                          <Form.Item>
                            <Input placeholder = "Write comment..." name = "comment" autoSize ></Input>
                          </Form.Item>

                          <Form.Item>
                            <Button block type = 'submitButton' htmlType = 'submit'>Submit</Button>
                          </Form.Item>
                        </Form>
